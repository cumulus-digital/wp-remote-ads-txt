...
class WPSFTest
{
    ...
    {
        $this->wpsf->add_settings_page(array('parent_slug' => 'woocommerce', 'page_title' => \esc_html__('Page Title', 'text-domain'), 'menu_title' => \esc_html__('menu Title', 'text-domain'), 'capability' => 'manage_woocommerce'));
    }
    /**
     * Validate settings.
     *
